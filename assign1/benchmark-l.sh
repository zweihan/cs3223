...
# revised benchmark.sh 
# - database is dropped and re-created if necessary
# - duration is increased to 6 minutes
...
# run benchmark  with 10 clients for a duration of 6 minutes
pgbench -c 10 -T 360 -s 10 $DBNAME > ${RESULTFILE}
